...
/*----------------------------------------------------------------------------
  Function for split screen
 *----------------------------------------------------------------------------*/
void slcdDisplaySplit(uint16_t value1 ,uint16_t format1, uint16_t value2, uint16_t format2){	
	uint16_t  tVariable = 0;
	uint16_t x[2];
	uint16_t y[2];
	x[1] = value1 % format1;
	tVariable = value1 - x[1]; //full number of system
	x[0] = tVariable / format1 % format1;
	
	tVariable = 0;
	y[1] = value2 % format2;
	tVariable = value2 - y[1]; //full number of system
	y[0] = tVariable / format2 % format2;
